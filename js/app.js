...
// Set this value to the base URL of the app serving Murder She generated JSON.
// The default value assumes you get JSON from http://murdershegenerated.com/players/8
murderApp.value('serverBaseURL', 'http://murdershegenerated.com/'); 

// If you are serving Murder She Generated JSON from another domain, 
// uncomment the following line to to enable cross domain calls (CORS).
murderApp.config(function($httpProvider) {
